<template>
  <article>
    ...
    <p>The information is used to enhance the vistor's experience when using the website to display personalised content.</p>
    ...
    <small>Last updated: November 2017</small>
